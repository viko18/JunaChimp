function run = cat_io_lazy(files,filedates)
...
%  filedates  .. filenames (cellstr or char) or datetimes or datenum
%
% Examples: 
...
% Robert Dahnke
% $Id: cat_io_lazy.m 1579 2020-03-10 13:51:42Z gaser $

%#ok<*ISCLSTR>
% iscellstr > isstring (MATLAB 2016+)
