...
function spmtype = cat_io_volctype_GUI(data,  intlim,  spm_type,prefix,suffix,expert,lazy)
  ...
  intscale.labels     = {'Yes (0-255)','Yes (0-1)','No'};
  intscale.values     = {2,1,0};
  intscale.val        = {1};
...
% -------------------------------------------------------------------------
  ...
  avg_img.help    = {'This function is for calculating the average of a set of images, which should be of same dimension and voxel size.'};
